...
public class SuperHeroeServiceImpl implements SuperHeroeService {
    ...
    public SuperHeroe createSuperHeroe(CreateSuperHeroe createSuperHeroe) {
        ...
        var opt = superHeroeRepository.findByName(createSuperHeroe.getName());
        if (opt.isPresent()) {
            log.info("::: SuperHeroe: {}, has already been created! :::",createSuperHeroe.getName());
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
                    "El superHeroe " + createSuperHeroe.getName() + " ya se encuentra en la base de datos.");
        }
